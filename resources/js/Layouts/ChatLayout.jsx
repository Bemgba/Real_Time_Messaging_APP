...
import { PencilIcon } from "@heroicons/react/24/solid"; // Adjust to the new icon name or path
               ...
               <div className="flex-1 overflow-auto">
                  {sortedConversations &&
                     sortedConversations.map((conversation) => (
                        ...
                        <ConversationItem
                           key={`${conversation.is_group ? "group_" : "user_"}${conversation.id || conversation.name}`} // Use additional unique identifier if needed
